...
class ActivitiesIndexViewTest(TestCase):
    ...
    def test_activities_ordered_by_start_date(self):
        ...
        self.assertEqual(
            activities[1], self.activity2
        )  # Second upcoming activity second
...
class ActivitiesArchiveViewTest(TestCase):
    def setUp(self):
        ...
        self.user1 = User.objects.create_user(
            username="testuser1", email="user1@example.com", password="password"
        )
        ...
        self.user2 = User.objects.create_user(
            username="testuser2", email="user2@example.com", password="password"
        )
        ...
        self.activity1 = Activity.objects.create(
            ...
            start=datetime.datetime(
                ...
                2023, 1, 15, 2, 0, tzinfo=timezone.get_current_timezone()
            ),
            location="Location 1",
        ...
        self.activity2 = Activity.objects.create(
            ...
            start=datetime.datetime(
                2023, 2, 15, tzinfo=timezone.get_current_timezone()
            ),
            end=datetime.datetime(
                2023, 2, 15, 2, 0, tzinfo=timezone.get_current_timezone()
            ),
            location="Location 2",
            committee=self.committee1,
            created_at=datetime.datetime(
        ...
        self.activity3 = Activity.objects.create(
            ...
            start=datetime.datetime(
                2022, 12, 15, tzinfo=timezone.get_current_timezone()
            ),
            end=datetime.datetime(
                2022, 12, 15, 2, 0, tzinfo=timezone.get_current_timezone()
            ),
            location="Location 3",
        ...
        self.activity4 = Activity.objects.create(
            ...
            start=datetime.datetime(
                2023, 1, 20, tzinfo=timezone.get_current_timezone()
            ),
            end=datetime.datetime(
                2023, 1, 20, 2, 0, tzinfo=timezone.get_current_timezone()
            ),
            location="Location 4",
            committee=self.committee2,
            created_at=datetime.datetime(
