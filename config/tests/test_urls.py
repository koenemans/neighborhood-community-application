...
from news.views import (
    HomePageView,
    IndexView as NewsIndexView,
    DetailView as NewsDetailView,
)
from activities.views import (
    IndexView as ActivitiesIndexView,
    DetailView as ActivitiesDetailView,
)
from committees.views import (
    IndexView as CommitteesIndexView,
    DetailView as CommitteesDetailView,
)
